                     ...
                     <table id="tabla" class="highlight centered responsive-table">
                         ...
                         <tbody>
                            ...
                            <td><c:out value="${pruebas.fecha}"/></td>
                             <td> 
                                <a  href="<c:url value="edituser.htm?id=${pruebas.id}"/> "> <i class="material-icons right">edit</i></a>
                                <a href="<c:url value="deluser.htm?id=${pruebas.id}"/>" ><i class="material-icons right">delete</i></a>
                            </td>
                            </tr>    
                            </c:forEach>    
                         </tbody>
